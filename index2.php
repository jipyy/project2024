...
<html lang="en">
  <head>
    ...
    <!-- logo title -->
    <link rel="icon" href="img/logo jipy.jpg" type="img/x-icon" />
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-warning ">
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          ...
          <!-- button -->
          <div>
            <button class="button-primary1 nav-item mx-2 text-light"><a href="formsignup.php" style="text-decoration:none; color:white;">SIGN UP</button>
          </div>
          <div>
          <button class="button-primary2 nav-item mx-2"><a href="formlogin.php" style="text-decoration:none; color:green;">LOGIN</a></button>
          </div>
        </div>
      </div>
       ...
       <div class="col-lg-2 col-md-2 col-sm-4 col-6 ">
          <div class="card text-center">
            ...
            <div class="card-body">
              ...
              <p class="card-text">RP. 31.000</p>
              <a href="#" class="btn btn-success d-grid">BELI</a>
            </div>
          </div>
        </div> 
      ...
      <div class="container h-100">
        <div class="row h-100">
            <div class="col-md-6 hero-tagline">
                <h1>SELAMAT DATANG 
                    DI WEBSITE <span class="fw-bold">JIPY REPTILE</span></h1>
                <P><span class="fw-bold">JIPY REPTILE</span> hadir untuk membantumu menemukan reptil berkualitas dan juga sehat dengan sumber yang terpercaya</P>

                <button class="button-lg-primary">Produk kami</button>
                <a href="#">
                    <img src="" alt="">
                </a>
            </div>
        ...
        <img src="img/banner.png" width="760" alt="" class="position-absolute end-0 bottom-0">
      </div>
    </section> -->
    <!-- 
    <h1>Hello, world!</h1>
